 ...
 * <p>
 * 可以替代传统的 binlog+pos 复制，能够实现主从自动定位和切换，可以不用指定文件和位置.
 * <p>
 * MySQL 5.6 开始支持.
 *
 * @author cristina
...
public class GtidSet {
    ...
    /**
     * similar 65a2b4eb-d393-11e5-b12c-525400497fb2:1-212739752:212771456-213150216,ca3d3488-7fa8-11ea-a06e-02000a0116af:1-92818936
     *
     * @param gitdSet gtid set comprised of closed intervals (like MySQL's executed_gtid_set).
     */
    public GtidSet(String gitdSet) {
        String[] uuid = gitdSet.replace("\n", "").split(",");
        String[] uuidSets = StrUtil.isEmpty(gitdSet) ? EMPTY_STRING : uuid;
